...
if (!defined('SMARTY_SYSPLUGINS_DIR')) {
    define('SMARTY_SYSPLUGINS_DIR', SMARTY_DIR . 'smarty' . DS . 'sysplugins' . DS);
}
if (!defined('SMARTY_PLUGINS_DIR')) {
    define('SMARTY_PLUGINS_DIR', SMARTY_DIR . 'smarty' . DS . 'plugins' . DS);
}
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        $this->debug_tpl = 'file:' . DS . 'static' . DS . 'tpl' . DS . 'debug.tpl';
