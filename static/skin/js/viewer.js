/**
 * 从https://www.onlyke.com/html/47.html所给代码修改而来
 * 其中大部分代码来自https://github.com/maxogden/minecraft-skin，
 * minecraft-skin是一份BSD授权的代码，但本身没附加授权信息，所以在此说明
 * 最终修改者为lxrmido@lxrmido.com，若有版权问题请联系删除
 */
function SkinViewer(global, container) {
	'use strict';
	...
	var render = function () {
		raf(render, renderer.domElement);
		var oldRad = rad;
